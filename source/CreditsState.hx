...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Guy who modded the engine\nand made it suck ass'],
			['travisgamemaker/cringe',			'dumbfuck',			'Stupid Bitch Programmer who reused \nCode from the guy above',							'https://twitter.com/real_tgm',			'00FFFF'],
			[''],
			['Engine Contributors'],
