...
class ColorShiftSwap extends Effect{
	public var shader:ColorShiftSwapShader = new ColorShiftSwapShader();
	...
	public function new(hueCol:Float=0,satCol:Float=0,valCol:Float=0)
	{
		shader.uTime.value = [hueCol, satCol, valCol];
...
class ColorShiftSwapShader extends FlxShader {
	@:glFragmentSource('
